    ...
    def get_frame(self):
        ...
        for (fX, fY, fW, fH) in self.faces:
            ...
            if emotion_text == 'happy':
                ...
                while self.smile_count >= 20 and self.smile_count % 20 == 0:
                    ...
                    image = cv2.rectangle(frame, (fX, fY), (fX + fW, fY + fH), (0, 255, 100), 2)
                    cv2.putText(image, ("smile_count" + str(self.smile_count)), (fX, fY), cv2.FONT_HERSHEY_SIMPLEX, 2,
                                (0, 255, 100), 4)
